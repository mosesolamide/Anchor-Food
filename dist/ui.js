...
import { getPacks, createNewPack } from "./storage.js";
import { pay } from "./paystack.js";
// DOM Element
export const productContainer = document.getElementById("product");
export const cartItems = document.getElementById("cartItem");
const locationModal = document.getElementById("location");
export let filteredFood = [...foodTempData];
export let currentPackId = 1;
const deliveryFee = 200;
export const setCurrentPackId = (id) => {
    currentPackId = id;
};
export const setFilteredFood = (food) => {
    filteredFood = food;
};
...
// ================= Display Food =================
export const displayFood = (isLoading = false) => {
    if (!productContainer)
        return;
    if (isLoading) {
...
const showOrderDetails = () => {
    var _a;
    (_a = document.getElementById("proceed-to-pay")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
        var _a, _b, _c;
        const packs = getPacks();
        const grandTotals = grandTotal();
    ...
    `;
        ...
        (_b = document.getElementById("edit-order")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
            locationModal === null || locationModal === void 0 ? void 0 : locationModal.classList.add("hidden");
        });
        (_c = document.getElementById("pay")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => {
